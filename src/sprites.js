...
function px(ctx, color, x, y, size = 1) {
    ctx.fillStyle = color;
    ctx.fillRect(x, y, size, size);
}
export function createStingraySprites() {
    // 3 frames of 24x24
    const frames = [];
    const body = '#2a4a6b';
    const wing = '#1a3a5a';
...
export function createFishSprites() {
...
export function createStarfishSprite() {
...
export function createJellyfishSprites() {
    const frames = [];
    for (let f = 0; f < 2; f++) {
...
export function createSharkSprite() {
...
export function createHeartSprite() {
