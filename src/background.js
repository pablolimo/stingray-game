...
export class Background {
    constructor() {
        Object.defineProperty(this, "layer1", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "layer2", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "layer3", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "offset1", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "offset2", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "offset3", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "LAYER_HEIGHT", {
            enumerable: true,
            configurable: true,
            writable: true,
    ...
    createLayer3() {
        ...
        for (let i = 0; i < 20; i++) {
            ...
            for (let seg = 0; seg < 5; seg++) {
                ...
                ctx.quadraticCurveTo(x + (seg % 2 === 0 ? 8 : -8), sy - height / 10, x + (seg % 2 === 0 ? 4 : -4), sy - height / 5);
            }
            ctx.stroke();
        }
        // Small rocks
