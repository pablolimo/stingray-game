...
import { CANVAS_WIDTH, CANVAS_HEIGHT, INITIAL_SCROLL_SPEED, MAX_SCROLL_SPEED, SCROLL_SPEED_INCREMENT, SCREEN_SHAKE_DURATION, SCREEN_SHAKE_MAGNITUDE, } from './constants';
function aabb(a, b) {
...
export class Game {
    constructor(canvas, ctx) {
        ...
        Object.defineProperty(this, "spawner", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "scrollSpeed", {
            ...
            configurable: true,
            writable: true,
            value: INITIAL_SCROLL_SPEED
        });
        Object.defineProperty(this, "shakeTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "spaceWasDown", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "titleAnimTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        switch (this.state) {
            ...
            case GameState.Playing:
                ...
                this.entities = this.entities.filter(e => {
                    if (e instanceof Fish && e.collected)
                        return false;
                    if (e instanceof Starfish && e.collected)
                        return false;
                    return true;
                });
                // Update particles
