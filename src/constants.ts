...
export const LEVEL4_SCORE_THRESHOLD = 4500;
...
export const SPEED_BOOST_DURATION = 7; // seconds (30% shorter than original 10 s)
...
export const OTTER_MAX_HP = 6000; // rock-throwing otter hit points (20× the original 300)
export const BLACK_SQUID_MAX_HP = SQUID_MAX_HP * 36; // black squid has 36× base squid HP (3× more resistant than before)
...
export const SKELETON_FISH_MAX_HP = SQUID_MAX_HP * 3;
